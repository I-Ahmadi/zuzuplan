          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              >
                ...
                <PaginationControls pagination={membersPagination} onPageChange={setMembersPage} className="border-0 bg-transparent px-0" />
              </AsyncContent>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              >
                ...
                <PaginationControls pagination={invitesPagination} onPageChange={setInvitesPage} className="border-0 bg-transparent px-0" />
              </AsyncContent>
            </CardContent>
          </Card>
        </section>
