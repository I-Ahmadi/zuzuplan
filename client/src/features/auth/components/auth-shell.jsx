      ...
      <div className="absolute bottom-28 right-[7vw] hidden w-64 lg:block">
        <div className="relative rounded border border-[#cce0ff] bg-white/90 p-5 shadow-[0_12px_34px_rgba(9,30,66,0.12)] backdrop-blur">
          ...
          <div className="relative h-28">
            <ConnectionLine className="left-6 top-7 w-[160px] rotate-[1.5deg]" />
            <ConnectionLine className="left-6 top-7 w-[77px] rotate-[51deg]" />
            <ConnectionLine className="left-[184px] top-8 w-[43px] rotate-[67deg]" />
            <ConnectionLine className="left-[72px] top-[88px] w-[129px] -rotate-[7deg]" />
            <ProjectNode className="left-0 top-1 z-10 border-[#85b8ff] bg-[#deebff]" />
            <ProjectNode className="right-4 top-2 z-10 border-[#7ee2b8] bg-[#dcfff1]" />
            <ProjectNode className="bottom-0 left-12 z-10 border-[#f5cd47] bg-[#fff7d6]" />
            <ProjectNode className="bottom-4 right-0 z-10 border-[#cce0ff] bg-white" />
          </div>
        </div>
      </div>
...
function ConnectionLine({ className }) {
  return (
    <span
      className={cn("absolute h-px origin-left bg-[#85b8ff]/80", className)}
    />
  );
}
